    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Provide the basic information for the course you want to create.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-full">
                      ...
                      <FormControl>
                        <Input placeholder="Course Duration" type="number" min="1" max="500" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
